 ...
 * Upstream file  : src/_crystals.ts
 ...
 *   1. Import specifier './utils.ts' -> './utils.js' (this repo's tsconfig does not enable
 *      allowImportingTsExtensions).
 *   2. Added the `@ts-nocheck` directive on line 1.
 *
 * No cryptographic logic was changed in this file. See ./ml-kem.ts for the FIPS 203
 * corrections and docs/compliance/FIPS-203-MATRIX.md for why the surface is vendored.
 */
/**
